        ...
        <form method="POST">
            ...
            <div class="p-4">
                ...
                <div class="mb-4">
                    ...
                    <input name="admin-pass" required type="password" class="form-control shadow-none"
                        placeholder="Password">

                </div>
                <button type="submit" name="login" class="btn btn-success text-blue custom-bg shadow-none">LOGIN</button>
